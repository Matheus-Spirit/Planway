document.addEventListener("DOMContentLoaded", function () {
    ...
    function loadUserExcursions() {
        ...
        // Carregar excursões ativas e passadas do localStorage
        const activeExcursions = JSON.parse(localStorage.getItem('excursoes')) || [];
        const pastExcursions = JSON.parse(localStorage.getItem('excursoesPast')) || [];

        // Filtrar excursões do usuário atual
        const userActiveExcursions = activeExcursions.filter(excursion => excursion.email === userEmail);
